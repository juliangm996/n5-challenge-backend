        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NombreEmpleado = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    ApellidoEmpleado = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    TipoPermiso = table.Column<int>(type: "int", nullable: false),
                    FechaPermio = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
